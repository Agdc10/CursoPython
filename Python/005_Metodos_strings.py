...
Todos los objetos en Python se engloban en dos categorías:
mutables o inmutables.
Los tipos básicos mutables son las listas, los diccionarios y los sets.
Los tipos básicos inmutables son los números, los string y las tuplas.
Los objetos mutables pueden ser cambiados en el mismo objeto, mientras que los inmutables no.
"""

# Para concatenar textos se hace con "x" o simplemente con una coma.
# Si ponemos coma nos pone entre los textosun espacio, con + no lo hace.
...
s_texto3 = "Vamos a ver cuántas veces aàrece la letra c"
...
# isalum(): Devuelve un boolean, Devuelve verdadero si todos los caracteres de la cadena son númericos y hay al menos un carácter. En caso contrario, devuelve falso.
s_texto7 = "9857654gf7"
...
# Te invito a que inspecciones el resto de funciones predefinidas para los string en:
